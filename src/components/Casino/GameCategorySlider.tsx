      ...
      <div className='relative'>
        ...
        >
          {games.map((game) => (
            ...
            >
              <div className='relative aspect-[3/4] h-[140px] w-full md:h-[200px]'>
                <Image
                  src={game.imageUrl}
                  alt={game.name}
                  fill
              ...
              <div className='px-3 py-2'>
                <h3 className='text-lemon-yellow mb-1 truncate text-[20px]'>{game.name}</h3>
                <p className='text-lemon-yellow/50 truncate text-[15px]'>{game.provider}</p>
              </div>
            </div>
          ))}
        </div>
