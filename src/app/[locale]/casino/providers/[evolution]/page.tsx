    ...
    <div className='space-y-8'>
      <div className='flex items-center gap-12'>
        <div className='flex items-center gap-6'>
          ...
          <div>
            <h1 className='text-lemon-yellow text-[22px] font-bold'>Evolution</h1>
      ...
      <div className='border-lemon-yellow mt-[20px] border-b transition-all duration-300'>
        <div className='flex items-center gap-2 pb-2'>
          ...
          <input
            ...
            placeholder='Search'
            className='text-lemon-yellow w-full bg-transparent outline-none'
          />
        </div>
      </div>
          ...
          >
            <div className='w-full'>
              <img
                src={game.imageUrl}
                alt={game.name}
                className='w-full object-cover object-top transition-transform duration-200 group-hover:scale-105'
                draggable={false}
              />
